...
$NEXTPREV_TEMPLATE['bootstrap_nav_prev'] = '
    <li><a class="prev" href="{url}" title="{url_label}"><i class="fa fa-arrow-left"></i></a></li>';
    
$NEXTPREV_TEMPLATE['bootstrap_nav_last'] = '';
    
$NEXTPREV_TEMPLATE['bootstrap_nav_next'] = '
    <li><a class="next" href="{url}" title="{url_label}"><i class="fa fa-arrow-right"></i></a></li>';
...
$NEXTPREV_TEMPLATE['bootstrap_item_current'] = '
    <li class="disabled"><a class="active" href="#" onclick="return false;" title="{url_label}">{label}</a></li>';
